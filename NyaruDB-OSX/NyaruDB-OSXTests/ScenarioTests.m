...
- (void)testInsertAndQueryString
{
    ...
    // count
    XCTAssertEqual([co whereIs:@"string" equal:@"B0"].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"string" equal:@"B5"].count, 2UL, @"");
    XCTAssertEqual([co whereIs:@"string" equal:@"B9"].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"string" equal:@"B10"].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"string" notEqual:@"B0"].count, 10UL, @"");
    XCTAssertEqual([co whereIs:@"string" notEqual:@"B5"].count, 9UL, @"");
    XCTAssertEqual([co whereIs:@"string" notEqual:@"B9"].count, 10UL, @"");
    XCTAssertEqual([co whereIs:@"string" notEqual:@"B10"].count, 11UL, @"");
    
    XCTAssertEqual([co whereIs:@"string" greater:@"B9"].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"string" greater:@"B8"].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"string" greater:@"B0"].count, 10UL, @"");
    XCTAssertEqual([co whereIs:@"string" greater:@"A0"].count, 11UL, @"");
    XCTAssertEqual([co whereIs:@"string" greaterEqual:@"C0"].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"string" greaterEqual:@"B9"].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"string" greaterEqual:@"B8"].count, 2UL, @"");
    XCTAssertEqual([co whereIs:@"string" greaterEqual:@"B0"].count, 11UL, @"");
    XCTAssertEqual([co whereIs:@"string" greaterEqual:@"A0"].count, 11UL, @"");
    
    XCTAssertEqual([co whereIs:@"string" less:@"A0"].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"string" less:@"B0"].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"string" less:@"B1"].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"string" less:@"B6"].count, 7UL, @"");
    XCTAssertEqual([co whereIs:@"string" less:@"B9"].count, 10UL, @"");
    XCTAssertEqual([co whereIs:@"string" less:@"C0"].count, 11UL, @"");
    XCTAssertEqual([co whereIs:@"string" lessEqual:@"A0"].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"string" lessEqual:@"B0"].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"string" lessEqual:@"B1"].count, 2UL, @"");
    XCTAssertEqual([co whereIs:@"string" lessEqual:@"B6"].count, 8UL, @"");
    XCTAssertEqual([co whereIs:@"string" lessEqual:@"B9"].count, 11UL, @"");
    XCTAssertEqual([co whereIs:@"string" lessEqual:@"C0"].count, 11UL, @"");
    
    XCTAssertEqual([co whereIs:@"string" like:@"b"].count, 11UL, @"");
    XCTAssertEqual([co whereIs:@"string" like:@"c"].count, 0UL, @"");
}
...
- (void)testInsertAndQueryNumber
{
    ...
    // count
    XCTAssertEqual([co whereIs:@"number" equal:@0].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"number" equal:@5].count, 2UL, @"");
    XCTAssertEqual([co whereIs:@"number" equal:@9].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"number" equal:@10].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"number" notEqual:@0].count, 10UL, @"");
    XCTAssertEqual([co whereIs:@"number" notEqual:@5].count, 9UL, @"");
    XCTAssertEqual([co whereIs:@"number" notEqual:@9].count, 10UL, @"");
    XCTAssertEqual([co whereIs:@"number" notEqual:@10].count, 11UL, @"");
    
    XCTAssertEqual([co whereIs:@"number" greater:@9].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"number" greater:@8].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"number" greater:@0].count, 10UL, @"");
    XCTAssertEqual([co whereIs:@"number" greater:@-1].count, 11UL, @"");
    XCTAssertEqual([co whereIs:@"number" greaterEqual:@10].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"number" greaterEqual:@9].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"number" greaterEqual:@8].count, 2UL, @"");
    XCTAssertEqual([co whereIs:@"number" greaterEqual:@0].count, 11UL, @"");
    XCTAssertEqual([co whereIs:@"number" greaterEqual:@-1].count, 11UL, @"");
    
    XCTAssertEqual([co whereIs:@"number" less:@-1].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"number" less:@0].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"number" less:@1].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"number" less:@6].count, 7UL, @"");
    XCTAssertEqual([co whereIs:@"number" less:@9].count, 10UL, @"");
    XCTAssertEqual([co whereIs:@"number" less:@10].count, 11UL, @"");
    XCTAssertEqual([co whereIs:@"number" lessEqual:@-1].count, 0UL, @"");
    XCTAssertEqual([co whereIs:@"number" lessEqual:@0].count, 1UL, @"");
    XCTAssertEqual([co whereIs:@"number" lessEqual:@1].count, 2UL, @"");
    XCTAssertEqual([co whereIs:@"number" lessEqual:@6].count, 8UL, @"");
    XCTAssertEqual([co whereIs:@"number" lessEqual:@9].count, 11UL, @"");
    XCTAssertEqual([co whereIs:@"number" lessEqual:@10].count, 11UL, @"");
}
...
- (void)testInsertAndQueryDate
{
    ...
    for (NSUInteger index = 1; index <= 10; index++) {
        ...
        XCTAssertEqual([[co whereIs:@"date" equal:date] count], 1UL, @"");
        
        date = [NSDate dateWithTimeIntervalSince1970:(index + 1) * 100];
        XCTAssertEqual([[co whereIs:@"date" less:date] count], index, @"");
    }
    
    XCTAssertEqual([[co whereIs:@"date" greaterEqual:[NSDate dateWithTimeIntervalSince1970:0]] count], 10UL, @"");
    XCTAssertEqual([[co whereIs:@"date" greaterEqual:[NSDate date]] count], 0UL, @"");
    XCTAssertEqual([[co whereIs:@"date" less:[NSDate date]] count], 10UL, @"");
}
...
- (void)testGreaterQuery
{
    ...
    XCTAssertEqual([co whereIs:@"n" greater:@5].count, 1UL, @"");
}
